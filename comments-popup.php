...
<p>L'URL à utiliser pour le trackback est : <em><?php trackback_url() ?></em></p>
<?php } ?>
...
<?php foreach ($comments as $comment) { ?>
	...
	<?php comment_text() ?>
	<p><cite><?php comment_type('Commentaire', 'Trackback', 'Pingback'); ?> par <?php comment_author_link() ?> &#8212; <?php comment_date() ?> à <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite></p>
	</li>
